 ...
 * tears them down. Cypress is given the harness origin as baseUrl, and the
 * gallery origin as CYPRESS_GALLERY_URL so neon-site.cy.ts can render the
 * public-site specimen against gallery/content.
 */
