...
```json
"dependencies": {
  "@neon-law-foundation/navigator-ux": "https://github.com/neon-law-foundation/navigator-ux/releases/download/v0.8.0/navigator-ux-v0.8.0.tgz",
  "react": "^19.2.0",
  "react-dom": "^19.2.0"
}
```
...
The current release is **`v0.8.0`**, and the URL above names it. Because the channel is a URL rather
